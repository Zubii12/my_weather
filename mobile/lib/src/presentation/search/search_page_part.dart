...
class SearchPagePart extends StatelessWidget {
  const SearchPagePart({
    Key? key,
          ...
          builder: (BuildContext context, List<String> weatherParameters) {
            return LocationWeatherContainer(
              builder: (BuildContext context, Map<int, LocationWeather> vm) {
                ...
                final int id = location.id;

                if (isLoading || vm[id] == null) {
                  return const Center(
                    child: CircularProgressIndicator(),
                  );
                }
                final LocationWeather locationWeather = vm[id]!;
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: GridView.builder(
                          itemCount: weatherParameters.length + 1,
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            if (index == weatherParameters.length) {
